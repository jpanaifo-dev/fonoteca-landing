    ...
    return (
        <div className="relative group/carousel w-full">
            ...
            <div className="overflow-hidden w-full cursor-grab active:cursor-grabbing" ref={emblaRef}>
                <div className="flex gap-6 pb-6 pt-2 px-2 items-stretch">
                    {allSpecies.map((species) => (
                        <div 
                            key={species.id}
                            className="flex-none w-[240px] md:w-[260px] select-none"
                        >
            ...
            {/* Navigation Buttons (Optional but helpful with Embla) */}
            <div className="hidden md:flex gap-2 absolute top-[-50px] right-0 opacity-0 group-hover/carousel:opacity-100 transition-opacity">
